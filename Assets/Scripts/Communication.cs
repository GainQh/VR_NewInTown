...
public class Communication : MonoBehaviour
{
    ...
    private SentenceLibrary sentenceLibrary;
    ...
    {   
        ...
        sentenceLibrary = FindObjectOfType<SentenceLibrary>();
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {   
            KeyValuePair<List<string>, List<AudioClip>> randomData = sentenceLibrary.GenerateRandomSentences();
